...
class Generator:
    ...
    def __init__(self, tf_session, tf_model, coverage_analyzer):
    ...
    def normalize(self, features):
        return np.float32(features / 255.)
    ...
    def run(self, image, curr_target, max_iterations):
        ...
        print('Adversarial examples count: {}/{}'.format(self.adv_found,self.gen_examples))
